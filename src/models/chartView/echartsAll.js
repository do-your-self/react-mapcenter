...
export function *initChartView(divId, result, obj,dispatch,group) {
  ...
  if (type == "Chart" || !type) {
    switch (selectStyle) {
      ...
      case "MedicalLineStyle":
        ...
        var instanceStr = echarts.init(chartView, commonChartsDataOption.style);
        instanceStr.setOption(commonChartsDataOption);
        myCharts = instanceStr;
        myCharts.on('click',function(params){
          params.color = '#d50000'
          params.event.target.style.fill = '#d50000'

          var object = {name:'time',time:group,value:params.name}
          //Map
          dispatch({
            type:'medicalBaseMapModel/getParamsReducer',payload:object
          })
          dispatch({
          ...
          //RightChart
          dispatch({
            type:'medicalBaseRightViewModel/getParamsReducer',payload:object
          })
          dispatch({
      ...
      case "MedicalIndexLineStyle":
        ...
        myChart.on('click',function(params){
          ...
          //Map
          dispatch({
            type:'medicalIndexMapModel/getParamsReducer',payload:object
          })
          dispatch({
          ...
          //RightChart
          dispatch({
            type:'medicalIndexRightViewModel/getParamsReducer',payload:object
          })
          dispatch({
